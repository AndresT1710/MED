...
namespace SMED.BackEnd.Controllers
{
    ...
    {
        private readonly IRepository<FoodDTO, int> _repository;

        public FoodController(IRepository<FoodDTO, int> repository)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<FoodDTO>> Create(FoodDTO dto)
        {
