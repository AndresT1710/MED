...
namespace SMED.BackEnd.Controllers
{
    ...
    {
        private readonly IRepository<ColorDTO, int> _repository;

        public ColorController(IRepository<ColorDTO, int> repository)
        {
            _repository = repository;
        }

        [HttpGet]
        public async Task<ActionResult<IEnumerable<ColorDTO>>> GetAll() => Ok(await _repository.GetAllAsync());
