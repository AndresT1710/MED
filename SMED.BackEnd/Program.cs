...
builder.Services.AddScoped<MedicalEvaluationRepository>();
builder.Services.AddScoped<IRepository<MedicalEvaluationDTO, int>, MedicalEvaluationRepository>();
builder.Services.AddScoped<TypeOfMedicalEvaluationRepository>();
builder.Services.AddScoped<IRepository<TypeOfMedicalEvaluationDTO, int>, TypeOfMedicalEvaluationRepository>();
builder.Services.AddScoped<MedicalEvaluationPositionRepository>();
builder.Services.AddScoped<IRepository<MedicalEvaluationPositionDTO, int>, MedicalEvaluationPositionRepository>();
builder.Services.AddScoped<MedicalEvaluationMembersRepository>();
builder.Services.AddScoped<IRepository<MedicalEvaluationMembersDTO, int>, MedicalEvaluationMembersRepository>();
builder.Services.AddScoped<OsteoarticularEvaluationRepository>();
builder.Services.AddScoped<IRepository<OsteoarticularEvaluationDTO, int>, OsteoarticularEvaluationRepository>();
builder.Services.AddScoped<JointConditionRepository>();
builder.Services.AddScoped<IRepository<JointConditionDTO, int>, JointConditionRepository>();
builder.Services.AddScoped<JointRangeOfMotionRepository>();
builder.Services.AddScoped<IRepository<JointRangeOfMotionDTO, int>, JointRangeOfMotionRepository>();
builder.Services.AddScoped<CurrentIllnessRepository>();
builder.Services.AddScoped<IRepository<CurrentIllnessDTO, int>, CurrentIllnessRepository>();
builder.Services.AddScoped<NeuromuscularEvaluationRepository>();
builder.Services.AddScoped<IRepository<NeuromuscularEvaluationDTO, int>, NeuromuscularEvaluationRepository>();
builder.Services.AddScoped<ShadeRepository>();
builder.Services.AddScoped<IRepository<ShadeDTO, int>, ShadeRepository>();
builder.Services.AddScoped<StrengthRepository>();
builder.Services.AddScoped<IRepository<StrengthDTO, int>, StrengthRepository>();
builder.Services.AddScoped<TrophismRepository>();
builder.Services.AddScoped<IRepository<TrophismDTO, int>, TrophismRepository>();
builder.Services.AddScoped<SessionsRepository>();
builder.Services.AddScoped<IRepository<SessionsDTO, int>, SessionsRepository>();
builder.Services.AddScoped<ActivityRepository>();
builder.Services.AddScoped<IRepository<ActivityDTO, int>, ActivityRepository>();
builder.Services.AddScoped<TypeOfActivityRepository>();
builder.Services.AddScoped<IRepository<TypeOfActivityDTO, int>, TypeOfActivityRepository>();
builder.Services.AddScoped<SensitivityLevelRepository>();
builder.Services.AddScoped<IRepository<SensitivityLevelDTO, int>, SensitivityLevelRepository>();
builder.Services.AddScoped<BodyZoneRepository>();
builder.Services.AddScoped<IRepository<BodyZoneDTO, int>, BodyZoneRepository>();
builder.Services.AddScoped<SensitivityEvaluationRepository>();
builder.Services.AddScoped<IRepository<SensitivityEvaluationDTO, int>, SensitivityEvaluationRepository>();
builder.Services.AddScoped<SkinEvaluationRepository>();
builder.Services.AddScoped<IRepository<SkinEvaluationDTO, int>, SkinEvaluationRepository>();
builder.Services.AddScoped<SwellingRepository>();
builder.Services.AddScoped<IRepository<SwellingDTO, int>, SwellingRepository>();
builder.Services.AddScoped<EdemaRepository>();
builder.Services.AddScoped<IRepository<EdemaDTO, int>, EdemaRepository>();
builder.Services.AddScoped<StatusRepository>();
builder.Services.AddScoped<IRepository<StatusDTO, int>, StatusRepository>();
builder.Services.AddScoped<ColorRepository>();
builder.Services.AddScoped<IRepository<ColorDTO, int>, ColorRepository>();
builder.Services.AddScoped<SpecialTestRepository>();
builder.Services.AddScoped<IRepository<SpecialTestDTO, int>, SpecialTestRepository>();
builder.Services.AddScoped<ResultTypeRepository>();
builder.Services.AddScoped<IRepository<ResultTypeDTO, int>, ResultTypeRepository>();
builder.Services.AddScoped<PhysiotherapyDiagnosticRepository>();
builder.Services.AddScoped<IRepository<PhysiotherapyDiagnosticDTO, int>, PhysiotherapyDiagnosticRepository>();
builder.Services.AddScoped<PhysiotherapyTreatmentRepository>();
builder.Services.AddScoped<IRepository<PhysiotherapyTreatmentDTO, int>, PhysiotherapyTreatmentRepository>();
builder.Services.AddScoped<IRepository<PainScaleDTO, int>, PainScaleRepository>();
builder.Services.AddScoped<PainScaleRepository>();
builder.Services.AddScoped<IRepository<ActionFDTO, int>, ActionFRepository>();
builder.Services.AddScoped<ActionFRepository>();
builder.Services.AddScoped<IRepository<ScaleDTO, int>, ScaleRepository>();
builder.Services.AddScoped<ScaleRepository>();
builder.Services.AddScoped<IRepository<PainMomentDTO, int>, PainMomentRepository>();
builder.Services.AddScoped<PainMomentRepository>();
builder.Services.AddScoped<IRepository<PosturalEvaluationDTO, int>, PosturalEvaluationRepository>();
